...
def upgrade() -> None:
    ...
    op.create_primary_key(
        "pk_observation_period", "observation_period", ["observation_period_id"], schema=schema
    )
    op.create_primary_key(
        "pk_visit_occurrence", "visit_occurrence", ["visit_occurrence_id"], schema=schema
    )
    op.create_primary_key("pk_visit_detail", "visit_detail", ["visit_detail_id"], schema=schema)
    op.create_primary_key(
        "pk_condition_occurrence", "condition_occurrence", ["condition_occurrence_id"], schema=schema
    )
    op.create_primary_key("pk_drug_exposure", "drug_exposure", ["drug_exposure_id"], schema=schema)
    op.create_primary_key(
        "pk_procedure_occurrence", "procedure_occurrence", ["procedure_occurrence_id"], schema=schema
    )
    op.create_primary_key(
        "pk_device_exposure", "device_exposure", ["device_exposure_id"], schema=schema
    )
    op.create_primary_key("pk_measurement", "measurement", ["measurement_id"], schema=schema)
    op.create_primary_key("pk_observation", "observation", ["observation_id"], schema=schema)
    ...
    op.create_primary_key(
        "pk_payer_plan_period", "payer_plan_period", ["payer_plan_period_id"], schema=schema
    )
    ...
    op.create_primary_key("pk_condition_era", "condition_era", ["condition_era_id"], schema=schema)
    ...
    op.create_primary_key("pk_vocabulary", "vocabulary", ["vocabulary_id"], schema=schema)
    op.create_primary_key("pk_domain", "domain", ["domain_id"], schema=schema)
    op.create_primary_key("pk_cost", "cost", ["cost_id"], schema=schema)
    op.create_primary_key("pk_concept_class", "concept_class", ["concept_class_id"], schema=schema)
    op.create_primary_key("pk_relationship", "relationship", ["relationship_id"], schema=schema)
    op.create_primary_key(
        "pk_cohort_definition", "cohort_definition", ["cohort_definition_id"], schema=schema
    )
