...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        None, "care_site", "concept", ["place_of_service_concept_id"], ["concept_id"]
    )
    op.create_foreign_key(
    ...
    op.create_index(
        "idx_condition_person_id_1", "condition_occurrence", ["person_id"], unique=False
    )
    op.create_index(
    ...
    op.create_foreign_key(
        None, "episode_event", "episode", ["episode_id"], ["episode_id"]
    )
    op.create_index(
    ...
    op.create_foreign_key(
        None, "location", "concept", ["country_concept_id"], ["concept_id"]
    )
    op.create_foreign_key(
        None,
        "measurement",
    ...
    op.create_foreign_key(
        None, "note", "concept", ["encoding_concept_id"], ["concept_id"]
    )
    ...
    op.create_index(
        "idx_note_nlp_concept_id_1", "note_nlp", ["note_nlp_concept_id"], unique=False
    )
    op.create_index("idx_note_nlp_note_id_1", "note_nlp", ["note_id"], unique=False)
    op.create_foreign_key(
        None, "note_nlp", "concept", ["note_nlp_concept_id"], ["concept_id"]
    )
    op.create_foreign_key(
        None, "note_nlp", "concept", ["note_nlp_source_concept_id"], ["concept_id"]
    )
    op.create_foreign_key(
    ...
    op.create_foreign_key(
        None, "observation", "provider", ["provider_id"], ["provider_id"]
    )
    op.create_foreign_key(
        None,
        "observation",
    ...
    op.create_foreign_key(
        None, "observation_period", "person", ["person_id"], ["person_id"]
    )
    op.create_foreign_key(
        None,
        "observation_period",
    ...
    op.create_index(
        "idx_visit_det_occ_id", "visit_detail", ["visit_occurrence_id"], unique=False
    )
    op.create_index(
        "idx_visit_det_person_id_1", "visit_detail", ["person_id"], unique=False
    )
    op.create_foreign_key(
        None,
        "visit_detail",
