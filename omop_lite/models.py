from sqlalchemy import (
    Table, Column, Integer, String, Date, ForeignKey, Numeric, Text, Index
)
...
cdm_source = Table('cdm_source', Base.metadata,
...
concept = Table('concept', Base.metadata,
...
note_nlp = Table('note_nlp', Base.metadata,
...
fact_relationship = Table('fact_relationship', Base.metadata,
    Column('domain_concept_id_1', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('fact_id_1', Integer, nullable=False),
    Column('domain_concept_id_2', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('fact_id_2', Integer, nullable=False),
    Column('relationship_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
...
location = Table('location', Base.metadata,
...
care_site = Table('care_site', Base.metadata,
...
provider = Table('provider', Base.metadata,
...
person = Table('person', Base.metadata,
    ...
    Column('gender_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    ...
    Column('race_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('ethnicity_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('location_id', Integer, ForeignKey('location.location_id')),
...
observation_period = Table('observation_period', Base.metadata,
    ...
    Column('period_type_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Index('idx_observation_period_id_1', 'person_id')
)

visit_occurrence = Table('visit_occurrence', Base.metadata,
    Column('visit_occurrence_id', Integer, primary_key=True),
    Column('person_id', Integer, ForeignKey('person.person_id'), nullable=False),
    Column('visit_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    ...
    Column('visit_type_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('provider_id', Integer, ForeignKey('provider.provider_id')),
    Column('care_site_id', Integer, ForeignKey('care_site.care_site_id')),
...
visit_detail = Table('visit_detail', Base.metadata,
    Column('visit_detail_id', Integer, primary_key=True),
    Column('person_id', Integer, ForeignKey('person.person_id'), nullable=False),
    Column('visit_detail_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    ...
    Column('visit_detail_type_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('provider_id', Integer, ForeignKey('provider.provider_id')),
    Column('care_site_id', Integer, ForeignKey('care_site.care_site_id')),
    ...
    Column('parent_visit_detail_id', Integer, ForeignKey('visit_detail.visit_detail_id')),
    Column('visit_occurrence_id', Integer, ForeignKey('visit_occurrence.visit_occurrence_id'), nullable=False),
...
condition_occurrence = Table('condition_occurrence', Base.metadata,
    Column('condition_occurrence_id', Integer, primary_key=True),
    Column('person_id', Integer, ForeignKey('person.person_id'), nullable=False),
    Column('condition_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    ...
    Column('condition_type_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
...
drug_exposure = Table('drug_exposure', Base.metadata,
    Column('drug_exposure_id', Integer, primary_key=True),
    Column('person_id', Integer, ForeignKey('person.person_id'), nullable=False),
    Column('drug_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    ...
    Column('drug_type_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('stop_reason', String(20)),
...
procedure_occurrence = Table('procedure_occurrence', Base.metadata,
    Column('procedure_occurrence_id', Integer, primary_key=True),
    Column('person_id', Integer, ForeignKey('person.person_id'), nullable=False),
    Column('procedure_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    ...
    Column('procedure_type_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
...
device_exposure = Table('device_exposure', Base.metadata,
    Column('device_exposure_id', Integer, primary_key=True),
    Column('person_id', Integer, ForeignKey('person.person_id'), nullable=False),
    Column('device_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    ...
    Column('device_type_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
...
measurement = Table('measurement', Base.metadata,
    Column('measurement_id', Integer, primary_key=True),
    Column('person_id', Integer, ForeignKey('person.person_id'), nullable=False),
    Column('measurement_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('measurement_date', Date, nullable=False),
    Column('measurement_datetime', Date),
    Column('measurement_time', String(10)),
    Column('measurement_type_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
...
observation = Table('observation', Base.metadata,
    Column('observation_id', Integer, primary_key=True),
    Column('person_id', Integer, ForeignKey('person.person_id'), nullable=False),
    Column('observation_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('observation_date', Date, nullable=False),
    Column('observation_datetime', Date),
    Column('observation_type_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('value_as_number', Numeric),
...
death = Table('death', Base.metadata,
...
note = Table('note', Base.metadata,
    Column('note_id', Integer, primary_key=True),
    Column('person_id', Integer, ForeignKey('person.person_id'), nullable=False),
    Column('note_date', Date, nullable=False),
    Column('note_datetime', Date),
    Column('note_type_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('note_class_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('note_title', String(250)),
    Column('note_text', Text, nullable=False),
    Column('encoding_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('language_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('provider_id', Integer, ForeignKey('provider.provider_id')),
    Column('visit_occurrence_id', Integer, ForeignKey('visit_occurrence.visit_occurrence_id')),
    Column('visit_detail_id', Integer, ForeignKey('visit_detail.visit_detail_id')),
...
specimen = Table('specimen', Base.metadata,
    Column('specimen_id', Integer, primary_key=True),
    Column('person_id', Integer, ForeignKey('person.person_id'), nullable=False),
    Column('specimen_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('specimen_type_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
...
payer_plan_period = Table('payer_plan_period', Base.metadata,
...
drug_era = Table('drug_era', Base.metadata,
...
dose_era = Table('dose_era', Base.metadata,
    Column('dose_era_id', Integer, primary_key=True),
    Column('person_id', Integer, ForeignKey('person.person_id'), nullable=False),
    Column('drug_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('unit_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
...
condition_era = Table('condition_era', Base.metadata,
...
episode = Table('episode', Base.metadata,
    Column('episode_id', Integer, primary_key=True),
    Column('person_id', Integer, ForeignKey('person.person_id'), nullable=False),
    Column('episode_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    ...
    Column('episode_object_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('episode_type_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('episode_source_value', String(50)),
    Column('episode_source_concept_id', Integer, ForeignKey('concept.concept_id'))
)

episode_event = Table('episode_event', Base.metadata,
    Column('episode_id', Integer, ForeignKey('episode.episode_id'), nullable=False),
    Column('event_id', Integer, nullable=False),
    Column('episode_event_field_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False)
)

metadata = Table('metadata', Base.metadata,
    Column('metadata_id', Integer, primary_key=True),
    Column('metadata_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('metadata_type_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
...
vocabulary = Table('vocabulary', Base.metadata,
    ...
    Column('vocabulary_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False)
)

domain = Table('domain', Base.metadata,
    Column('domain_id', String(20), primary_key=True),
    Column('domain_name', String(255), nullable=False),
    Column('domain_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False)
)

cost = Table('cost', Base.metadata,
    Column('cost_id', Integer, primary_key=True),
    Column('cost_event_id', Integer, nullable=False),
    Column('cost_domain_id', String(20), ForeignKey('domain.domain_id'), nullable=False),
    Column('cost_type_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
...
concept_class = Table('concept_class', Base.metadata,
    Column('concept_class_id', String(20), primary_key=True),
    Column('concept_class_name', String(255), nullable=False),
    Column('concept_class_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False)
)

relationship = Table('relationship', Base.metadata,
...
concept_relationship = Table('concept_relationship', Base.metadata,
    ...
    Column('relationship_id', String(20), ForeignKey('relationship.relationship_id'), nullable=False),
    Column('valid_start_date', Date, nullable=False),
    Column('valid_end_date', Date, nullable=False),
    Column('invalid_reason', String(1))
)

concept_synonym = Table('concept_synonym', Base.metadata,
...
concept_ancestor = Table('concept_ancestor', Base.metadata,
    Column('ancestor_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('descendant_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('min_levels_of_separation', Integer, nullable=False),
    Column('max_levels_of_separation', Integer, nullable=False)
)

source_to_concept_map = Table('source_to_concept_map', Base.metadata,
    Column('source_code', String(50), nullable=False),
    Column('source_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('source_vocabulary_id', String(20), nullable=False),
    Column('source_code_description', String(255)),
    Column('target_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('target_vocabulary_id', String(20), ForeignKey('vocabulary.vocabulary_id'), nullable=False),
    Column('valid_start_date', Date, nullable=False),
    Column('valid_end_date', Date, nullable=False),
    Column('invalid_reason', String(1))
)

drug_strength = Table('drug_strength', Base.metadata,
    Column('drug_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('ingredient_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
...
cohort_definition = Table('cohort_definition', Base.metadata,
    ...
    Column('definition_type_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
    Column('cohort_definition_syntax', Text),
    Column('subject_concept_id', Integer, ForeignKey('concept.concept_id'), nullable=False),
